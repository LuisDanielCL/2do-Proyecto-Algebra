 ...
 * @author LuisDanielCL
 */
public class AddMatriz3 extends javax.swing.JFrame {

    /**
     * Creates new form AddMatriz
     */
    mainApp3 ventanaPrincipal;
    int filas, columnas, numMatriz;
    JTextField [][] valores = new JTextField[5][5];
    public AddMatriz3(int pFilas, int pColumnas, mainApp3 pVentanaPrincipal) throws Exception {
