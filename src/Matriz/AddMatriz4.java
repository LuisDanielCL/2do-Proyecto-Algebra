 ...
 * @author LuisDanielCL
 */
public class AddMatriz4 extends javax.swing.JFrame {

    /**
     * Creates new form AddMatriz
     */
    mainApp4 ventanaPrincipal;
    int filas, columnas, numMatriz;
    JTextField [][] valores = new JTextField[5][5];
    public AddMatriz4(int pFilas, int pColumnas, mainApp4 pVentanaPrincipal) throws Exception {
